...
<div class="dashboard__button-container">
    ...
    <a class="dashboard__button" href="/dashboard/users/employees/create">
                ...
                <?php foreach($users as $us){ ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--actions">
                            <a class="table__action table__action--edit" href="/dashboard/users/employees/edit?id=<?php echo $us->id;?>">
                                <i class="fa-solid fa-user-pen"></i>
                                Editar
                            </a>
                            <form method="POST" action="/dashboard/users/employees/delete" class="table__form">
